...
def main(json_path='options/FNet/train_stage2.json'):
    ...
    num_iter_per_epoch=train_size
    print('Number of iters per epoch: ',num_iter_per_epoch)
    total_iters = int(opt['train']['total_iter'])

    total_epochs = math.ceil(total_iters / (num_iter_per_epoch))+2
    print('Total number of epochs: ',total_epochs)
    
    for epoch in range(total_epochs+1):  # keep running
